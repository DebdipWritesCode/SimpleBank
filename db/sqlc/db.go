...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.subtractAccountBalanceStmt, err = db.PrepareContext(ctx, subtractAccountBalance); err != nil {
		return nil, fmt.Errorf("error preparing query SubtractAccountBalance: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.subtractAccountBalanceStmt != nil {
		if cerr := q.subtractAccountBalanceStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing subtractAccountBalanceStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	subtractAccountBalanceStmt *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		subtractAccountBalanceStmt: q.subtractAccountBalanceStmt,
