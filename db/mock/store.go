...
// Source: github.com/DebdipWritesCode/SimpleBank/db/sqlc (interfaces: Store)
...
func (m *MockStore) SubtractAccountBalance(arg0 context.Context, arg1 db.SubtractAccountBalanceParams) (db.Account, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) SubtractAccountBalance(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
